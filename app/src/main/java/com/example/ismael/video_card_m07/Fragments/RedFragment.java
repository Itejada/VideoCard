...
public class RedFragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.busqueda_archivo:
                Toast.makeText(getContext(),"Se abriria el gestor de archivos: ",Toast.LENGTH_LONG).show();
                break;
            case R.id.busqueda_url:
                Toast.makeText(getContext(),"Lanzaria una llamada al buscador para reconocer la URL",Toast.LENGTH_LONG).show();
                break;
        }
    }
